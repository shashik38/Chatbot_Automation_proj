...
bot = telegram.Bot(token='5945961019:AAEMa5CvvQb7xBBoSQfDYUJFx7OuYd4kPcc') #Replace TOKEN with your token string

from telegram.ext import Updater, CommandHandler, MessageHandler, Filters

updater = Updater(token='5945961019:AAEMa5CvvQb7xBBoSQfDYUJFx7OuYd4kPcc', use_context=True) #Replace TOKEN with your token string
